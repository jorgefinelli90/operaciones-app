...
export function OrderRow({
  ...
  function renderCell(
    ...
    switch (column) {
        ...
        return (
          <div className="flex items-center gap-2">
            {order.hasInvoice && (
              <span
                title="Factura"
                className="inline-flex items-center gap-1 rounded-md border border-blue-500/20 bg-blue-500/10 px-2 py-1 text-[11px] font-semibold text-blue-400"
              >
                <ReceiptText
                  size={13}
                />
            ...
            {order.hasCreditNote && (
              <span
                ...
                className="inline-flex items-center gap-1 rounded-md border border-orange-500/20 bg-orange-500/10 px-2 py-1 text-[11px] font-semibold text-orange-400"
              >
                <FileText
                  size={13}
                />
      ...
      case "amount":
        return (
          <div className="min-w-0 whitespace-nowrap text-center text-xs font-semibold tabular-nums">
            {amount}
          </div>
        );
    }
