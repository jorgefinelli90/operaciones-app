...
const navigation = [
  ...
  {
    name: "Notas de Crédito y Cupones",
    href: "/credit-notes",
    icon: FileText,
  },
  {
...
export function Sidebar() {
  ...
  const { user, loading, can } =
    useAuth();

  /*
   * Mientras AuthContext está cargando,
   * no mostramos navegación protegida.
   */
